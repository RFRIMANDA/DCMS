...
use App\Http\Controllers\Iso37001Controller;
...
// Risk
Route::middleware(['checkrole:admin,manager,manajemen'])->group(function () {
...
// ISO37001
Route::get('/index', [Iso37001Controller::class, 'index'])->name('iso37001.index');
// });
