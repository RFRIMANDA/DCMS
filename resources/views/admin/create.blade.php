                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="email" name="email" class="form-control" id="email" value="{{ old('email') }}" placeholder="user@tatametal.com" required>
                            </div>
                        </div>
                            ...
                            document.addEventListener('DOMContentLoaded', function () {
                                ...
                                checkboxes.forEach(cb => {
                                    cb.addEventListener('change', function () {
                                        // Otomatis nonaktifkan 'Pilih Semua' jika ada checkbox yang tidak dicentang
