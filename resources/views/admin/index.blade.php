    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          ...
          <a href="/admin/create" title="Buat User" class="btn btn-sm btn-success mb-3">
          ...
          <button title="Cari User" type="submit" class="btn btn-primary"><i class="bi bi-search"></i></button> <!-- Added 'ms-2' for margin -->
            <a href="{{ route('admin.kelolaakun') }}" title="Refresh" class="btn btn-secondary"><i class="bi bi-arrow-clockwise"></i></a>
        </form>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <form id="delete-form-{{ $user->id }}" action="{{ route('admin.destroy', $user->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
