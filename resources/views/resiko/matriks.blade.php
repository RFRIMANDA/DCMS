...
<div class="container">
    ...
    <div class="card mb-3">
        <span class="badge bg-secondary" style="font-size: 1.25rem;">Matriks Before:<br>{{ $resiko_nama }}</span>
    </div>
    ...
    {{-- Matriks Before --}}
    <div class="card mb-3">
    <span class="badge bg-info" style="font-size: 1.25rem;">MATRIKS BEFORE</span>
    </div>
    ...
    <a class="btn btn-success" href="{{ route('resiko.edit', ['id' => $lol]) }}" title="Edit Matriks">
