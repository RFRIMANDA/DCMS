              ...
              <form action="{{ route('login.action') }}" method="POST">
                ...
                <div class="col-12">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <input type="text" placeholder="Masukkan Email" name="email" class="form-control" id="email" required>
                ...
                <div class="col-12">
                    ...
                    <div class="input-group">
                      <input type="password" placeholder="Masukkan Password" name="password" class="form-control" id="yourPassword" required>
