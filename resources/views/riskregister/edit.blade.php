...
<div class="container">
    ...
    <form action="{{ route('riskregister.update', $riskregister->id) }}" method="POST">
        ...
        <input type="hidden" name="id_divisi" value="{{ $riskregister->id_divisi }}">
         ...
         <div class="card p-3 my-3">
            <span class="badge bg-info" style="font-size: 1.25rem;">Edit Risk & Opportunity Register</span>
            <br>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        <div class="row mb-3 align-items-center">
         ...
         <!-- Risk Edit Section -->
         <div class="card p-3 my-3">
            <span class="badge bg-info" style="font-size: 1.25rem;">Edit Risiko</span>
            <br>
            ...
            <div id="riskInputContainer">
                ...
                <div class="risk-card border p-3 my-2">
                    <div class="mb-3">
                        <label for="nama_resiko_{{ $resiko->id }}" class="form-label"><strong>Risiko</strong></label>
        ...
        <div class="col-sm-8 offset-sm-2">
            <div class="form-check">
                ...
                <label class="form-check-label" for="tindakan_to_delete_{{ $tindakan->id }}">
                    <span class="badge bg-danger">Hapus Tindakan ini</span>
                </label>
            </div>
        </div>
    </div>
@endif
        ...
        <div class="mt-3">
            ...
            <button type="submit" class="btn btn-success" title="Update">Update
